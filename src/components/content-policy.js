...
let { bindPrefAndInit } = Cu.import("resource://i2pctrl/modules/Utils.js", {});

function ContentPolicy() {
  this.uriFingerprinting = null;
  let that = this;
  bindPrefAndInit("extensions.i2pctrl.resource_and_chrome_uri_fingerprinting",
    function (enabled) {
...
ContentPolicy.prototype = {
  ...
  classID: Components.ID("{4c03be7d-babe-990e-f0da-f3689e564898}"),
  contractID: "@i2bb.net/content-policy;1",
